...
import { calculateAttemptPoints, calculateRoundTotal, isAnswerCorrect, POINTS } from './scoring';
...
describe('scoring utilities', () => {
  ...
  describe('calculateRoundTotal', () => {
    ...
    it('adds perfect round bonus for 10/10 score', () => {
      ...
      expect(result).toBe(roundPoints + POINTS.ROUND_COMPLETE_BONUS + POINTS.PERFECT_ROUND_BONUS);
    });
